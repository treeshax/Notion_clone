...
//           <span style={styles.badge}>{tasks.filter((t) => !t.completed).length} pending</span>
//         </div>
...
//             <span style={{ flex: 1, textAlign: "center" }}>LEVEL OF TASK</span>
//             <span style={{ flex: 1, textAlign: "center" }}>MARK IF COMPLETE</span>
...
//                   borderLeft: `4px solid ${lc.border}`,
//                 }}
//               >
//                 {isEditing ? (
//                   <>
...
//         button:hover { filter: brightness(0.93); transform: scale(0.98); transition: 0.12s; }
//       `}</style>
//     </div>
//   );
// }
